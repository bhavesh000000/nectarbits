...
export default function WhyChooseUs() {
  return (
    <div className="why_chooseus_wrapper">
    <div className="container">
        <div className="why_chooseus_wrap">
           <div className="why_chooseus_title">
                <h3>Why Choose Us</h3>
           ...
           <div className="why_chooseus_block">
               <ul> 
                    <li>
                        <div className="why_chooseus_sec">
                            <div className="why_chooseus_img">
