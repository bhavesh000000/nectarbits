    ...
    <div className="awards_wrapper">
        <div className="container">
            <div className="awards_wrap">
                <div className="awards_block">
                    <div className="awards_img">
                        <div className="awards_img_block">
                            <img src={awards_bg} alt="" />
                            <div className="awards_img_conte">
                                <h3><b>5</b> 
                                 <span>
                    ...
                    <div className="awards_sec">
                        <div className="awards_conte">
                            <h3>Awards & Recongnisations</h3>
                            <p>Leading Rating & Review Platforms Rank Nectarbits Among Top Software Development Companies Due To Our 
                            Tech Assistance In Clients' Digital Transformation.</p>
                            <ul>
                                <li>
                                    <img src={awards_img1} alt="" />
                                    <h4>Wadline</h4>
                                </li>
                                <li>
                                    <img src={awards_img2} alt="" />
                                    <h4>Develop4u</h4>
                                </li>
                                <li>
                                    <img src={awards_img3} alt="" />
                                    <h4>Clutch</h4>
                                </li>
                                <li>
                                    <img src={awards_img4} alt="" />
                                    <h4>Themanifest</h4>
                                </li>
                                <li>
                                    <img src={awards_img5} alt="" />
                                    <h4>GoodFirm</h4>
                                </li>
                                <li>
                                    <img src={awards_img6} alt="" />
                                    <h4>SoftwareSuggest</h4>
                                </li>
                            </ul>
                        </div>
                    </div>
